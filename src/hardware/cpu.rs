...
pub const CPU_OPCODES: &[Opcode] = &[
    ...
    Opcode::new_unofficial(0x93, "AXA", AddressingMode::IndexedIndirect, 6, Cpu::axa),
    ...
    Opcode::new_unofficial(0xA3, "LAX", AddressingMode::IndirectIndexed, 6, Cpu::lax),
    ...
    Opcode::new_unofficial(0xB3, "LAX", AddressingMode::IndexedIndirect, 5, Cpu::lax),
